					...
					<ul class="navbar-nav me-2 mt-1">
						<c:choose>
							<c:when test="${user.role eq 'Admin'}">
								...
								<li class="nav-item mt-1"><a class="nav-link active"
									href="#"><i
										class="fa-solid fa-list-check"></i> Orders</a></li>
							...
							<c:otherwise>
								...
								<c:url value="/menu" var="menuUrl" />
								<a
									class="nav-link active" href="${menuUrl}"> <i
										class="fa-solid fa-bread-slice"></i> Menu
								</a></li>
						...
						<c:if test="${user.role eq 'Customer' }">
							<li class="nav-item d-none d-lg-inline d-xl-inline d-xxl-inline mt-1 mx-lg-2">
				                <a class="nav-link active" href="#"><i class="fa-solid fa-bag-shopping fa-lg"></i> Cart</a>
				            </li>
						</c:if>
						...
						<li
							...
							<div class="row me-0 align-middle my-2">
								...
								<c:url value="${user.profilepic}" var="profile" />
									<img src="${profile}"
										class="rounded-circle mt-1" height="45"
						...
						<div class="dropdown d-none d-lg-inline d-xl-inline d-xxl-inline">
							<a
								...
								aria-expanded="false"> <c:url
									value="${user.profilepic}" var="profile" /> <img
								src="${profile}"
			...
			<div class="offcanvas offcanvas-start w-75" tabindex="-1"
				...
				<div class="offcanvas-body ms-lg-auto">
					<ul class="navbar-nav me-2 mt-1">
						...
						<li class="nav-item mt-1 mx-lg-2"><a class="nav-link active"
							href="/login"> <i class="fa-solid fa-arrow-right-from-bracket"></i> Log In
						</a></li>
					</ul>
				</div>
			</div>
